...
const TopDoctors = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <div className="w-full overflow-x-auto scrollbar-hide pt-5 px-3 sm:px-0">
      ...
      <button
        ...
        className="bg-red-100 text-gray-700 px-12 py-3 rounded-full mt-10 hover:scale-105 transition-all"
      >
        More
      </button>
    </div>
