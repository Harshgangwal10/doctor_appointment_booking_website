...
import RealtedDoc from "../components/RealtedDoc";
    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-90px] sm:mt-0">
       ...
       {/*---- Related Doctors ---- */}
       <RealtedDoc docId={docId} speciality ={ docInfo.speciality} />
